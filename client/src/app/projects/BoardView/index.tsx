    ...
    return (
        ...
        >
            {task.attachments && task.attachments.length > 0 && (
                <Image 
                    src={`https://projectmanagement-s3-bucket.s3.amazonaws.com/${task.attachments[0].fileURL}`} 
                        ...
                        <div className="flex -space-x-[6px] overflow-hidden">
                            {task.assignee && (
                                <Image
                                    ...
                                    src={`https://projectmanagement-s3-bucket.s3.amazonaws.com/${task.assignee.profilePictureUrl!}`}
                            ...
                            {task.author && (
                                <Image
                                    ...
                                    src={`https://projectmanagement-s3-bucket.s3.amazonaws.com/${task.author.profilePictureUrl!}`}
